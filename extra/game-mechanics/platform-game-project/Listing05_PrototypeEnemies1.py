...
class Enemy:
    ...
    def update(self, platforms):
        ...
        if self.speedX > 0:
            lineIntersection = LineString([(self.centre[0]+enemyHalfSize, self.centre[1]+enemyHalfSize-4),
                                           (self.centre[0]+enemyHalfSize, self.centre[1]+enemyHalfSize+4)])
        else:
            lineIntersection = LineString([(self.centre[0]-enemyHalfSize, self.centre[1]+enemyHalfSize-4),
                                           (self.centre[0]-enemyHalfSize, self.centre[1]+enemyHalfSize+4)])
...
enemy1 = Enemy(400, 535)
enemy2 = Enemy(300, 435)
enemy3 = Enemy(600, 435)
enemy4 = Enemy(500, 325)
